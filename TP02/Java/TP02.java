...
public class TP02 {	
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < quantidadeEntrada; i++) {
			...
			arquivo = personagens[i].lerArquivo(convertida);
			personagens[i].acharNome(arquivo);
			personagens[i].altura(arquivo);
			personagens[i].peso(arquivo);
			personagens[i].corDoCabelo(arquivo);
			personagens[i].corDaPele(arquivo);
			personagens[i].corDosOlhos(arquivo);
			personagens[i].nascimento(arquivo);
			personagens[i].genero(arquivo);
			personagens[i].homeworld(arquivo);
			personagens[i].print();
